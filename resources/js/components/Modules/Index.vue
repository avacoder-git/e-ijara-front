<template>
    <div>
                ...
                <div class="col-lg-2">
                    <div class="carousel-nav">
                        ...
                        <a class="carousel-control-next" href="#carouselExampleIndicators" role="button"
                           data-slide="next">
                            <img src="image/right2.svg" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div id="carouselExampleIndicators" class="carousel slide" data-interval="4000"
                         data-ride="carousel">
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"><span></span>
                            </li>
            ...
            <div class="row">
                <div class="col-12 " id="fields">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="date-list">
                            <div class="date"><a href="">Hammasini ko'rish <img src="image/left.svg" style="transform: rotate(180deg); margin-left: 16px" alt=""></a></div>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div id="fields1Indicators" class="carousel slide" data-interval="4000"
                                 data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="rectangle position-relative">
                                                    <div class="rectangle-img"><img src="image/yer.jpg" alt=""></div>
                                                    <div class="d-flex justify-content-between">
                                                        <div class="rectangle-lot">17.04.2022</div>
                                                        <div class="rectangle-lot">Y1714216-457071</div>
                                                    </div>
                                                    ...
                                                    <div class="rectangle-footer">
                                                        <div class="rectangle-ga">1.82 Ga</div>
                                                        <button class="rectangle-save"><img src="/image/Bookmark.svg"
                                                                                            alt=""></button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <ol class="carousel-indicators">
                                    <li data-target="#fields1Indicators" data-slide-to="0" class="active"><span></span>
                                    </li>
                                    <li data-target="#fields1Indicators" data-slide-to="1"><span></span></li>
                                </ol>
                                <div class="carousel-nav">
                                    <a class="carousel-control-prev" href="#fields1Indicators" role="button"
                                       data-slide="prev">
                                        <img src="image/left.svg" alt="">
                                    </a>
                                    <a class="carousel-control-next" href="#fields1Indicators" role="button"
                                       data-slide="next">
                                        <img src="image/left.svg" alt="">
                                    </a>
                                </div>
                    ...
                    <div class="rectangle">
                        <div class="block">
                            ...
                            <div class="block-numbers">
                                <div class="son">36808</div>
                                <div class="splitter"></div>
                                <div class="ga">671513.37 Ga</div>
                            </div>
                        </div>
                        <div class="block">
                            <img src="image/stat1.svg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="rectangle">
                        ...
                        <div class="block">
                            <img src="image/ajratilgan.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="rectangle">
                        ...
                        <div class="block">
                            <img src="image/tanlovdagi.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    ...
                    <div class="map">
                        ...
                        <div class="list">
                            <ul class="nav nav-tabs" id="mapList" role="tablist">
                                ...
                                <li class="date-list">
                                    <div class="date">17 aprel 2022 16:49 holatiga ko’ra</div>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="map" role="tabpanel"
                                    ...
                                    <div class="container-fluid">
                                        <div class="row justify-content-between">
                                            <div class="col-6 px-0 mt-4">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 793 517"
                                                     aria-label="Map of Uzbekistan" class="svg-map" role="radiogroup"
                                                     map="[object Object]">
                                                    <path id="andijan" data-region="1703" name="Andijan"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Andijan"
                                                          class="svg-map__location"></path>
                                                    <path id="bukhara" data-region="1706" name="Bukhara"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Bukhara"
                                                          class="svg-map__location"></path>
                                                    <path id="fergana" data-region="1730" name="Fergana"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Fergana"
                                                          class="svg-map__location"></path>
                                                    <path id="jizzakh" data-region="1708" name="Jizzakh"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Jizzakh"
                                                          class="svg-map__location"></path>
                                                    <path id="namangan" data-region="1714" name="Namangan"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Namangan"
                                                          class="svg-map__location"></path>
                                                    <path id="navoiy" data-region="1712" name="Navoiy"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Navoiy"
                                                          class="svg-map__location"></path>
                                                    <path id="qashqadaryo" data-region="1710" name="Qashqadaryo"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Qashqadaryo"
                                                          class="svg-map__location"></path>
                                                    <path id="karakalpakstan" data-region="1735" name="Karakalpakstan"
                                                          ...
                                                          tabindex="0" role="radio" aria-label="Karakalpakstan"
                                                          class="svg-map__location"></path>
                                                    <path id="samarqand" data-region="1718" name="Samarqand"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Samarqand"
                                                          class="svg-map__location"></path>
                                                    <path id="sirdaryo" data-region="1724" name="Sirdaryo"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Sirdaryo"
                                                          class="svg-map__location"></path>
                                                    <path id="surxondaryo" data-region="1722" name="Surxondaryo"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Surxondaryo"
                                                          class="svg-map__location"></path>
                                                    <path id="tashkent" data-region="1727" name="Tashkent"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Tashkent"
                                                          class="svg-map__location"></path>
                                                    <path id="tashkent" data-region="1727" name="Tashkent"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Tashkent"
                                                          class="svg-map__location"></path>
                                                    <path id="xorazm" data-region="1733" name="Xorazm"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Xorazm"
                                                          class="svg-map__location"></path>
                                                    <path id="aral-sea" data-region="1735" name="Aral Sea"
                                                          ...
                                                          tabindex="-1" role="radio" aria-label="Aral Sea"
                                                          class="svg-map__location"></path>
                                                </svg>
                                            </div>
        ...
        <div class="container-fluid section-2">
            ...
            <div class="row">
                <div class="col-12">
                    <div id="quick-links" class="carousel slide" data-interval="4000"
                         data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row">
                        ...
                        <ol class="carousel-indicators">
                            <li data-target="#quick-links" data-slide-to="0" class="active"><span></span>
                            </li>
                            <li data-target="#quick-links" data-slide-to="1"><span></span></li>
                        </ol>
                        <div class="carousel-nav">
                            <a class="carousel-control-prev" href="#quick-links" role="button"
                               data-slide="prev">
                                <img src="image/left.svg" alt="">
                            </a>
                            <a class="carousel-control-next" href="#quick-links" role="button"
                               data-slide="next">
                                <img src="image/left.svg" alt="">
                            </a>
                        </div>
        ...
        <div class="modal" id="check-application" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <input type="text" placeholder="Taklif raqami" class="form-control">
                    </div>
...
$(function () {
    var t = 4000
    $(".carousel-indicators .active span").animate({
        width: "100%",
    }, t, function () {

    })
    $('.carousel-nav a').click(function () {
        $('.carousel-indicators li span').css('width', 0)
    })
    $(".carousel").on('slid.bs.carousel', function () {
        if ($('.carousel-indicators .active').data('slide-to') === 0)
            $('.carousel-indicators li span').css('width', 0)
        $(".carousel-indicators .active span").animate({
            width: "100%",
        }, t - 100, function () {
